...
<div class="logBackground">
    ...
    <h2>当前位置 ：咨询添加 </h2>
    <h3>咨询基本信息</h3>
    <form action="./consultAddDeal.php" method="post" name="article" id="article" enctype="multipart/form-data" onsubmit="return test();">
        ...
        <div>回复状态&nbsp;&nbsp;&nbsp;
            ...
            <label for="ishf">
                <input type="radio" name="ishf"  value="0" >待回复
            </label>
            <label for="">
                <input value="1" type="radio" name="ishf"  checked>已回复
            </label>
        </div>
        ...
        <div>
            ...
            <textarea  name="recontent" id="recontent"  style="width: 239px;height: 100px;border: 1px solid rgba(86,61,124,.6);resize: none; "  ></textarea>
