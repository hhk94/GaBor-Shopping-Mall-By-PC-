...
//        $db=new DbMysql();
        $result=$this->db->select("select * from mall_admin where username='$username'",1);
        $state="";
...
//                密码错误
                ...
                $this->db->sql("update mall_admin set loginTime='".  time()."',ip='$ip',loginSum=loginSum+1 where username='$username'");
