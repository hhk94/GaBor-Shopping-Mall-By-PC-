...
<div class="logBackground">
    ...
    <h2>当前位置 ：品牌添加 </h2>
    <h3>品牌基本信息</h3>
    <form action="./productppAddDeal.php" method="post" name="article" id="article" enctype="multipart/form-data" onsubmit="return test();">


        <div>
            <label for="ppname">品牌名称</label>
            <input type="text" name="ppname" style="border: 1px solid rgba(86,61,124,.6);" required>
        </div>


        <div>
            <label for="pporder">排序位置</label>
            <input type="text" name="pporder" style="border: 1px solid rgba(86,61,124,.6);" required>
        </div>
        <div>是否推荐&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <label for="">
                <input value="0" type="radio" name="recommend" id="recommend" checked>否
            </label>
        </div>
        ...
        <div>
            ...
            <textarea  name="ppinfo" id="ppinfo"  style="width: 239px;height: 100px;border: 1px solid rgba(86,61,124,.6);resize: none; " ></textarea>
