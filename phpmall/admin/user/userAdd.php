...
<div class="logBackground">
    ...
    <h2>当前位置 ：添加会员 </h2>
    <h3>会员基本信息</h3>
    <form action="./userAddDeal.php" method="post">
        <div>
            <label for="username">会员账号</label>
            <input type="text" name="username" style="border: 1px solid rgba(86,61,124,.6);" required>
            <span>登录账号</span>
        </div>
        <div>
            <label for="password">会员密码</label>
            <input type="text" name="password" style="border: 1px solid rgba(86,61,124,.6);" required>
            <span>登录密码</span>
        </div>
        <div>
            <label for="email">会员邮箱</label>
            <input type="text" name="email" style="border: 1px solid rgba(86,61,124,.6);" >
        </div>
        <div>
            <label for="tiwen">提示问题</label>
            <input type="text" name="tiwen" style="border: 1px solid rgba(86,61,124,.6);" >
            <span>用于找回密码</span>
        </div>
        <div>
            <label for="huida">回答问题</label>
            <input type="text" name="huida" style="border: 1px solid rgba(86,61,124,.6);" >
            <span>用于找回密码</span>
        </div>
        <div>
            <label for="mobile">手机号码</label>
            <input type="text" name="mobile" style="border: 1px solid rgba(86,61,124,.6);" >
            <span>用于找回密码</span>
        </div>
        <div>
            <label for="xingming">真实姓名</label>
            <input type="text" name="xingming" style="border: 1px solid rgba(86,61,124,.6);" >
            <span>用于找回密码</span>
        </div>
