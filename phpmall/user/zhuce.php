...
<div class="login-container">
    ...
    <form action="" class="regform" id="regform" method="post">
        <div class="loginLogo"><img src="img/logo.png" alt=""></div>
        <p>有账号，去 <a href="login.php">登录</a></p>
        ...
        <div class="form-group has-success has-feedback inputDiv">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control inputhight" name="reg_username"  id="reg_username" aria-describedby="inputGroupSuccess4Status" placeholder="账号" onblur="hiddenwarn($('#reg_username'),'账号通过',1)">
            </div>
        </div>
        ...
        <div class="form-group has-success has-feedback inputDiv">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control inputhight" name="reg_password" id="reg_password"  aria-describedby="inputGroupSuccess4Status" placeholder="密码" onblur="hiddenwarn($('#reg_password'),'密码通过',2)">
            </div>
        </div>

        <div class="form-group has-success has-feedback inputDiv">
            <label class="control-label sr-only" for="login_password">再次输入密码</label>
            <div class="input-group">
                <span class="input-group-addon inputLeft"><img src="img/input2.png" alt=""></span>
                <input type="text" class="form-control inputhight" name="reg_password_again" id="reg_password_again"  aria-describedby="inputGroupSuccess4Status" placeholder="再次输入密码" onblur="hiddenwarn($('#reg_password_again'),'再次密码通过',2)">
            </div>
        </div>

        <div class="form-group has-success has-feedback inputDiv">
            <label class="control-label sr-only" for="login_password">电话</label>
            <div class="input-group">
                <span class="input-group-addon inputLeft"><img src="img/input2.png" alt=""></span>
                <input type="text" class="form-control inputhight" name="reg_phone" id="reg_phone"  aria-describedby="inputGroupSuccess4Status" placeholder="电话" onblur="hiddenwarn($('#reg_phone'),'手机号码ok',4)">
            </div>
        </div>
        ...
        <div class="form-group has-success has-feedback inputDiv">
            ...
            <div class="input-group">
                <span class="input-group-addon inputLeft"><img src="" alt="" id="regcode"></span>
                <input type="text" class="form-control inputhight" name="reg_code" id="reg_code" aria-describedby="inputGroupSuccess4Status" placeholder="验证码"  onfocus="codeF('regcode')" >
            </div>
        </div>
