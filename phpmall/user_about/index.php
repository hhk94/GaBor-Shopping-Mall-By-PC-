...
$info=$db->select(" select * from mall_article inner join mall_articleType on mall_article.typeid=mall_articleType.id  where mall_article.id = '$id' and mall_articleType.leixing='关于我们'",1);
...
<div class="container">
        <div class="about_left">
            ...
            <ul>
                ...
                foreach ($list as $row){
                    if($id==$row['id']){
                        echo "<li class='about_left_active'><a href='{$webdir}/user_about/index.php?id={$row['id']}' >{$row['title']}</a></li>";
                        }else{
                ...
                <li><a href="<?php echo $webdir?>/user_links/links.php">友情链接</a></li>
