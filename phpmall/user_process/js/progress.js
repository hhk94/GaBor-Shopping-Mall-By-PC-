...
$(function() {
    ...
    function BtnClick(btn) {
        btn.on('click', function () {
            var elm = $(this).parent().children('div').find('.indexName').val();
            // console.log(elm)
            var phNub = $(this).parent().children('div').find('.indexNum').val();
            // console.log(phNub )
            var location = $(this).parent().children('div').find('.indexLocal').val();
            // console.log(location)
            var xuqiu = $(this).parent().children('div').find('.xuqiu').val();
            var gongsi = $(this).parent().children('div').find('.indexcom').val();
            var leaveMessage = $(this).parent().children('div').find('.leaveMessage').val();
