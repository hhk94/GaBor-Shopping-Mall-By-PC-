...
//            详情图片
        ...
        $(".section4_5>.container>img").attr("src",data[index][15]);
        $(".section4_6>.bigPic>img").attr("src",data[index][16]);
        $(".section4_6>.container>img").attr("src",data[index][17]);
        $(".section4_7>.bigPic>img").attr("src",data[index][18]);




        $(".swiper-slide1:nth-of-type(1)>img").attr("src",data[index][13]);
        $(".swiper-slide1:nth-of-type(2)>img").attr("src",data[index][14]);
