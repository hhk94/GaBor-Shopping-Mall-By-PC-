    ...
    <div class="chuguicontainer">
        ...
        <div class="leftBanner">
            <a href="<?php echo $webdir."/user_product/product.php?id={$result1['id']}"?>" target="_blank">
                <img src="img/leftBanner.png" alt="">
            </a>
        </div>
        <div class="rightBanner">
            <div class="rightTop">
                <img src="img/rightTop-2.png" alt="">
            </div>
            <div class="rightBottom">
                <a href="<?php echo $webdir."/user_product/product.php?id={$result1['id']}"?>" target="_blank">
                    <h1>全屋定制套餐 - <?php echo strindex($result1['title'],6,"...")?></h1>
                    <h2>18㎡投影面积，六大空间，随心定制</h2>
<!--                    <h2>赠送烟机灶具</h2>-->
                    <h3>￥<?php echo $result1['price']?></h3>
                    <h4>立即购买</h4>
                </a>
            </div>
        </div>
...
<div class="quanwusec3">
    <div class="chuguicontainer">
        <div class="sec6top clearfix-1">

            <div class="right chuguiList" >
                ...
                $sql3.=$parm3." limit 0,1 ";
                $result3= $chugui->select($sql3,1);

//                echo $sql3;
                ?>

                <div>
                    <a href="<?php echo $webdir."/user_product/product.php?id={$result3['id']}"?>" target="_blank">
                        <img src="<?php echo str_replace("../../","../../",$result3['pic']) ?>" alt="">

                        <div class="listFloat">
                            <h1><?php echo strindex($result3['title'],4,"...")?></h1>
                        </div>
                    </a>
                </div>
