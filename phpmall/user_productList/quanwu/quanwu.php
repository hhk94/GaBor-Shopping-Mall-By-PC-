...
$sql=" select id from mall_productList where typename = '全屋定制' or typename = '木门' ";

$result=$chugui->select($sql);
...
foreach ($result as $row){
    ...
    $xjid=$db->select("select id from mall_productList where idpath like '%_{$row['id']}%' ");
    ...
    $parm.=" typeid = '{$row['id']}' or ";


}

$parm.="  typeid in ($xjids)) ";
...
<div class="chuguibanner">
    <img src="newimg/topbanner-quanwu.png" alt="">
</div>
<div><img src="newimg/anniu-quanwu.png" alt=""></div>
<div><a href="http://www2.53kf.com/webCompany.php?arg=10133101&style=2&kflist=off&kf=19680502&zdkf_type=3&language=cn&charset=GBK" target="_blank"><img src="newimg/cy8999.png" alt=""></a></div>
<div><img src="newimg/jiange.png" alt=""></div>
<div><a href="http://www2.53kf.com/webCompany.php?arg=10133101&style=2&kflist=off&kf=19680502&zdkf_type=3&language=cn&charset=GBK" target="_blank"><img src="newimg/cy12999.png" alt=""></a></div>
<div ><img src="newimg/jiange.png" alt=""></div>
<div><a href="http://siemensgabor.com/user_product/product.php?id=52" target="_blank"><img src="newimg/qw16800.png" alt=""></a></div>
